...
- **Secrets**: Continue to protect API Keys via environment variables (`GOOGLE_API_KEY`, `TELEGRAM_TOKEN`, `GITHUB_PAT`, `SLACK_WEBHOOK_URL`, `PLEX_URL`, `PLEX_TOKEN`, `DEEDEE_API_TOKEN`, `GEMINI_IMAGE_MODEL`).
