    ...
    return (
        <main className="flex h-screen flex-col bg-zinc-950 text-zinc-200 p-6 md:p-12 overflow-y-auto w-full">
            <header className="mb-8 max-w-4xl mx-auto w-full">
                <h1 className="text-3xl font-bold tracking-tight text-white mb-2">Agent Goals</h1>
                <p className="text-zinc-400">
                    Multi-session work the agent is executing, with resumption checkpoints. Not for user TODOs or reminders.
                </p>
            </header>
