                            ...
                            <>
                                ...
                                {channels.filter(ch => !ch.isIm && !ch.isMpim).length > 0 && (
                                    <div className="space-y-0.5 relative">
                                        <div className="sticky top-0 bg-zinc-900/90 backdrop-blur pb-2 pt-1 z-10">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    placeholder="Filter..."
                                                    className="w-full bg-zinc-800 border border-zinc-700 rounded pl-7 pr-2 py-1 text-[10px] text-white placeholder-zinc-600 focus:border-purple-500/50 focus:outline-none"
                                                />
                                            </div>
                                        </div>
                                ...
                                {channels.filter(ch => ch.isMpim).length > 0 && (
                                    <div className="space-y-0.5 relative">
                                        <div className="sticky top-0 bg-zinc-900/90 backdrop-blur pb-2 pt-2 z-10 border-t border-zinc-700/50">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-zinc-800 border border-zinc-700 rounded pl-7 pr-2 py-1 text-[10px] text-white focus:outline-none"
                                                />
                                            </div>
                                        </div>
                                        {filteredChannels.filter(ch => ch.isMpim).map(ch => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex items-center gap-1 min-w-0 flex-1">
                                                        <MessageCircle className="w-2.5 h-2.5 flex-shrink-0 text-zinc-500" />
                                                        <span className="font-medium truncate">{ch.name}</span>
                                                    </div>
                                                </button>
                                            );
                                ...
                                {channels.filter(ch => ch.isIm).length > 0 && (
                                    <div className="space-y-0.5 relative">
                                        <div className="sticky top-0 bg-zinc-900/90 backdrop-blur pb-2 pt-2 z-10 border-t border-zinc-700/50">
                                            <div className="text-[10px] text-zinc-500 font-medium mb-1.5 uppercase tracking-wider">DMs</div>
                                            <div className="relative">
                                                <Search className="w-3 h-3 text-zinc-500 absolute left-2 top-1/2 -translate-y-1/2" />
                                                <input
                                                    type="text"
