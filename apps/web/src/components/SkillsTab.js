...
import { Plus, Trash2, Edit, Save, X, Power, Key, AlertTriangle, Eye } from 'lucide-react';
import { getSkills, saveSkill, deleteSkill, toggleSkill, saveSkillSecrets, getSkill } from '@/app/skills/actions';
        ...
        <div className="flex flex-col">
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-zinc-400 text-sm">Manage agent capabilities and personas.</p>
                </div>
                <button
