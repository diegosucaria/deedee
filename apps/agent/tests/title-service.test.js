...
describe('TitleService', () => {
    ...
    beforeEach(() => {
        ...
        titleService.config = { getModel: jest.fn().mockReturnValue('gemini-2.0-flash'), logUsageFromResponse: jest.fn().mockReturnValue({ cost: 0, tokens: 0 }), getThinkingConfig: () => null };
    });
