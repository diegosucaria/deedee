...
- Current location: check calendar results for travel indicators (flights from TripIt, all-day events like "Stay at...", "Hotel...", "Airbnb...", or location fields with a foreign city). For flights: if the user has arrived somewhere and hasn't departed yet, they're at the arrival city. If no travel is detected, default to the home city: call getFact("user_home_city").
