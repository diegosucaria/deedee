...
4. Call recommend_outfit(context: "today, <weather>, <occasion summary>", count: 2, render: true). With render:true the tool renders a virtual-mirror image for EVERY proposal so all of them show up with a polished render in the wardrobe UI (instead of a bare garment grid). Each proposal line in the response includes an "IMAGE_PATH:" line if a render was produced.
