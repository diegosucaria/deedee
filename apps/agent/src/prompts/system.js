...
const FACTS_RECALL_RULE = "This list is a summary, not everything I know, and each line is shortened. Before you answer from it, and ALWAYS before you say you do not know or ask him something he may have told you already: call getFact(key) for the full value of any fact, listed here or not, or searchMemory(query) to find one by words. Write a fact with rememberFact(key, value) only when it still matters next month, correct one with updateFact(key, value), drop one with forgetFact(key).";
