...
router.get('/stats/cache-hit-rate', (req, res) => proxyRequest(req, res, 'GET', '/internal/stats/cache-hit-rate'));
router.get('/stats/model-usage', (req, res) => proxyRequest(req, res, 'GET', '/internal/stats/model-usage'));
