...
- **Empty chats are cleaned up** on navigation: a chat with no messages, no pin and the untouched title `New Chat` is deleted. A chat you named or cleared keeps its row.
